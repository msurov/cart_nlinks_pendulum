...
def solve_for_control_inputs(mechsys : MechanicalSystem) -> ca.SX:
  ddq = ca.SX.sym('ddq', mechsys.qdim)
  u = ca.pinv(mechsys.B) @ (mechsys.M @ ddq + mechsys.C @ mechsys.dq + mechsys.G)
  return ca.Function('control_inputs', [mechsys.q, mechsys.dq, ddq], [u])
